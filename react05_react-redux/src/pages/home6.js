...
import { addAction } from '../stores/counter/actionCreators';
import { fetchHomeDataAction } from '../stores/home/actionCreators';
...
const mapStateToProps = state => ({
  add_counter: state.counterData.add_counter
})
